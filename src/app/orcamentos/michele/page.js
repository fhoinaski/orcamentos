...
const Orcamento = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white shadow-md rounded-md">
      <h1 className="text-3xl md:text-2xl sm:text-xl font-bold text-teal-700 mb-4">🏰 ORÇAMENTO DE SERVIÇOS</h1>
      ...
      <h2 className="text-2xl md:text-xl sm:text-lg font-semibold text-teal-600 mt-6 mb-2">1. Instalações e Adaptações</h2>
      <h3 className="text-xl md:text-lg sm:text-base font-semibold text-teal-500 mt-4 mb-2">1.1. Instalação da Porta do Banheiro</h3>
      ...
      <p className="text-gray-700 mb-4"><strong>Atenciosamente,</strong><br />
        ...
        <div >
          <a  className='flex w-full mt-2 items-center text-green-700 font-semibold' href="https://wa.me/5548996273552" target="_blank" rel="noopener noreferrer">
